...
INSERT INTO restclienttracking.users (u_id, u_first_name, u_last_name, u_email, u_password, u_phone) VALUES (2, 'user', 'admin', 'admin@example.com', '{bcrypt}$2a$10$ZKhlcv0ki4chQZhiUGupM.50BUfDavDXPfmHsn3np.IcA26IO8fSC', '123');
